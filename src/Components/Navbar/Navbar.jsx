...
const Navbar = () => {
  ...
  return (
    <div
      ...
      } flex w-full items-center justify-between px-8 py-6 transition-all duration-300 ease-in-out esm:bg-black esm:text-white md:px-20 lg:bg-transparent lg:text-black`}
    >
      ...
      <div className="hidden items-center gap-12 font-poppinsSemibold text-lg lg:flex lg:gap-6 xl:gap-12">
        <a
          className={`relative text-slate-500 transition-all duration-500 ease-in-out after:absolute after:bottom-0 after:left-0 after:w-full after:origin-center after:bg-slate-500 after:content-[''] hover:text-gray-600 esm:after:h-0 lg:after:h-[2px]`}
          href="#home"
        >
          Home
        </a>
